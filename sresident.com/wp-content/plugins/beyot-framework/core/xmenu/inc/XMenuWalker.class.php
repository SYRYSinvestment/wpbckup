...
class XMenuWalker extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $current_object_id = 0 ) {
		...
		if (($depth === 0) && isset($xmenu_meta['custom-content-value']) && $xmenu_meta['custom-content-value']) {
			$item_output .= '<div class="' . join(' ', $a_classes) . '">' .  apply_filters('xmenu_custom_content', $xmenu_meta['custom-content-value']) . '</div>';
		}
		else {
