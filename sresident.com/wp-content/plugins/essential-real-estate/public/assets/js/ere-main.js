...
(function ($) {
    ...
    ERE = {
        ...
        propertyMap: function () {
            $('.ere-property-map').each(function () {
                var $this = $(this);
                var lat = $this.data('lat'),
                    lng = $this.data('lng');
                if ((lat === undefined) || (lat === '') || (lng === undefined) || (lng === '') || isNaN(lat) || isNaN(lng)) {
                    $this.append($this.data('no-location-text'));
                    ...
                    var title = $this.data('title'),
                        ...
                        zoomLevel = $this.data('zoom-level');
                    ...
                    if (mapStyle === 'property') {
                        var property_maker = $this.data('property-marker');
                        ...
                        google.maps.event.addListener(marker, 'click', function () {
                            infobox.setContent(property_maker);
